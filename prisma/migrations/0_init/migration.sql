...
-- CreateTable
CREATE TABLE "public"."residencePhotos" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    ...
    CONSTRAINT "residencePhotos_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "public"."residences" (
    ...
    "updatedAt" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "addedById" UUID,
    "tripId" UUID DEFAULT gen_random_uuid(),
    "url" TEXT NOT NULL,
    "title" TEXT NOT NULL,
    "description" TEXT,
    "notes" TEXT,
...
-- CreateTable
CREATE TABLE "public"."tripMembers" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "createdAt" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT "tripMembers_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "public"."residencePhotos" ADD CONSTRAINT "public_residencePhotos_residenceId_fkey" FOREIGN KEY ("residenceId") REFERENCES "public"."residences"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."tripMembers" ADD CONSTRAINT "public_tripMembers_memberId_fkey" FOREIGN KEY ("memberId") REFERENCES "auth"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."tripMembers" ADD CONSTRAINT "public_tripMembers_tripId_fkey" FOREIGN KEY ("tripId") REFERENCES "public"."trips"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."trips" ADD CONSTRAINT "public_trips_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "auth"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
